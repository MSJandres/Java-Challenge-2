...
const collectEmployees = function() {
  // TODO: Get user input to  and return an array of employee objects
  const employees = [];
  let addMore = true;
...
const displayAverageSalary = function(employeesArray) {
  ...
  const formattedSalary = Number.isInteger(averageSalary) ? averageSalary.toFixed(0) : averageSalary.toFixed(2);
